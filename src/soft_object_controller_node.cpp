...
void main_soft_object_manipulator(int argc,char ** argv)
{
    ...
    double y[M] = {0};
    double x_star[N] = {0};
    static double gram_matrix_data[10000] = {0};
    int gram_matrix_size[2] = {0};
    double X_data[100*N] = {0};
    int X_size[2] = {0};
    double Y_data[100*M] = {0};
    int Y_size[2] = {0};
    ...
    double y_star[M] = {0};
    double cov_star;
    double X_update_data[101*N] = {0};
    int X_update_size[2] = {0};
    double Y_update_data[101*M] = {0};
    ...
    ros::Subscriber subFeedbackPoint = node.subscribe("/soft_object_tracking/centroid", 1000, feedbackCallback);
...
//                 std::cout<< y_star[i]<<" ";
            ...
            for(int i=0;i<M;i++){
                ...
                if(stopFlag)
                    ...
                    armCommand.data[i] = y_star[i] * CONTROL_GAIN;
